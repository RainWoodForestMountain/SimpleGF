...
public static class LuaBinder
{
	public static void Bind(LuaState L)
	{
		...
		GameFramework_VideoPlayerEventWrap.Register(L);
		GameFramework_UGUIScrollRectActionWrap.Register(L);
		GameFramework_IDModelWrap.Register(L);
		GameFramework_NetworkModuleWrap.Register(L);
		GameFramework_UIModuleWrap.Register(L);
		GameFramework_TimeModuleWrap.Register(L);
		GameFramework_ModuleControllerWrap.Register(L);
		GameFramework_MessageTypeWrap.Register(L);
		GameFramework_MessageModuleWrap.Register(L);
		GameFramework_MessageWrap.Register(L);
		GameFramework_MessageBodyWrap.Register(L);
		GameFramework_MessageBody_ByteBufferWrap.Register(L);
		GameFramework_MessageBody_StringWrap.Register(L);
		GameFramework_MessageBody_GameObjectWrap.Register(L);
		GameFramework_AssetLoadRecordWrap.Register(L);
		GameFramework_DoTweenAnimationWrap.Register(L);
		GameFramework_SliderWrap.Register(L);
		GameFramework_UGUIAdaptationWrap.Register(L);
		GameFramework_UGUIGradientColorWrap.Register(L);
		GameFramework_UGUISpriteAnimationWrap.Register(L);
		GameFramework_UGUIScrollViewWrap.Register(L);
		GameFramework_ObjectListWrap.Register(L);
		GameFramework_ObjectListChildWrap.Register(L);
		GameFramework_GameObjectLayoutGridGroupWrap.Register(L);
		GameFramework_GameObjectLayoutElementWrap.Register(L);
		GameFramework_CheckingStringWrap.Register(L);
		GameFramework_UIEffectDepthWrap.Register(L);
		GameFramework_CommonKeyWrap.Register(L);
		GameFramework_ChannelDataWrap.Register(L);
		GameFramework_ChannelDataPackageWrap.Register(L);
		GameFramework_UtilityWrap.Register(L);
		GameFramework_UtilityUnityWrap.Register(L);
		GameFramework_MonoBaseWrap.Register(L);
		GameFramework_UGUIClickEventListenerWrap.Register(L);
		GameFramework_UGUIClickEventListenerWithPropertyWrap.Register(L);
		GameFramework_ProjectDatasWrap.Register(L);
		GameFramework_RunningTimeDataWrap.Register(L);
		GameFramework_PersistenceDataWrap.Register(L);
		GameFramework_ByteBufferWrap.Register(L);
		GameFramework_UILayersWrap.Register(L);
		GameFramework_UGUIFlashWrap.Register(L);
		GameFramework_ModuleBaseWrap.Register(L);
		GameFramework_UGUIEventListenerWrap.Register(L);
		L.EndModule();
		L.BeginModule("GameContent");
		GameContent_ToLuaModuleWrap.Register(L);
		GameContent_ToLuaBridgeWrap.Register(L);
		L.EndModule();
		...
		L.RegFunction("Action_GameFramework_Message", System_Action_GameFramework_Message);
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int System_Action_GameFramework_Message(IntPtr L)
	{
		try
		{
			int count = LuaDLL.lua_gettop(L);
			...
			if (count == 1)
			{
				Delegate arg1 = DelegateTraits<System.Action<GameFramework.Message>>.Create(func);
				ToLua.Push(L, arg1);
			}
			else
			{
				LuaTable self = ToLua.CheckLuaTable(L, 2);
				Delegate arg1 = DelegateTraits<System.Action<GameFramework.Message>>.Create(func, self);
				ToLua.Push(L, arg1);
			}
			return 1;
		}
