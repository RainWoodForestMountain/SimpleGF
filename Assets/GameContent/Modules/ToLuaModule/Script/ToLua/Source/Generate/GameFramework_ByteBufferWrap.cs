...
public class GameFramework_ByteBufferWrap
{
	public static void Register(LuaState L)
	{
		L.BeginClass(typeof(GameFramework.ByteBuffer), typeof(System.Object));
		...
		L.RegFunction("New", _CreateGameFramework_ByteBuffer);
		L.RegFunction("__tostring", ToLua.op_ToString);
		L.EndClass();
	}

	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int _CreateGameFramework_ByteBuffer(IntPtr L)
	{
		try
		{
			...
			if (count == 0)
			{
				GameFramework.ByteBuffer obj = new GameFramework.ByteBuffer();
			...
			else if (count == 1 && TypeChecker.CheckTypes<byte[]>(L, 1))
			{
				...
				GameFramework.ByteBuffer obj = new GameFramework.ByteBuffer(arg0);
				ToLua.PushObject(L, obj);
				return 1;
			}
			...
			{
				return LuaDLL.luaL_throw(L, "invalid arguments to ctor method: GameFramework.ByteBuffer.New");
			}
		}
		catch (Exception e)
		{
