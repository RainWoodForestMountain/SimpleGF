...
public class DelegateFactory
{
	...
	public static void Register()
	{
		...
		dict.Add(typeof(System.Action<GameFramework.Message>), factory.System_Action_GameFramework_Message);
		...
		DelegateTraits<System.Action<GameFramework.Message>>.Init(factory.System_Action_GameFramework_Message);
		...
		TypeTraits<System.Action<GameFramework.Message>>.Init(factory.Check_System_Action_GameFramework_Message);
		...
		StackTraits<System.Action<GameFramework.Message>>.Push = factory.Push_System_Action_GameFramework_Message;
	...
	class System_Action_GameFramework_Message_Event : LuaDelegate
	{
		public System_Action_GameFramework_Message_Event(LuaFunction func) : base(func) { }
		public System_Action_GameFramework_Message_Event(LuaFunction func, LuaTable self) : base(func, self) { }

		public void Call(GameFramework.Message param0)
		{
			func.BeginPCall();
			func.PushValue(param0);
			func.PCall();
		...
		public void CallWithSelf(GameFramework.Message param0)
		{
			func.BeginPCall();
			func.Push(self);
			func.PushValue(param0);
	...
	public System.Action<GameFramework.Message> System_Action_GameFramework_Message(LuaFunction func, LuaTable self, bool flag)
	{
		if (func == null)
		{
			System.Action<GameFramework.Message> fn = delegate(GameFramework.Message param0) { };
			return fn;
		}

		if(!flag)
		{
			System_Action_GameFramework_Message_Event target = new System_Action_GameFramework_Message_Event(func);
			System.Action<GameFramework.Message> d = target.Call;
			target.method = d.Method;
			return d;
		}
		else
		{
			System_Action_GameFramework_Message_Event target = new System_Action_GameFramework_Message_Event(func, self);
			System.Action<GameFramework.Message> d = target.CallWithSelf;
			target.method = d.Method;
			return d;
		}
	}

	bool Check_System_Action_GameFramework_Message(IntPtr L, int pos)
	{
		return TypeChecker.CheckDelegateType(typeof(System.Action<GameFramework.Message>), L, pos);
	}

	void Push_System_Action_GameFramework_Message(IntPtr L, System.Action<GameFramework.Message> o)
	{
		ToLua.Push(L, o);
	}
