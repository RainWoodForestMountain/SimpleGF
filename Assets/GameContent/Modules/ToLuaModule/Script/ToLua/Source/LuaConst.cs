...
{
    public static string luaDir = Application.dataPath + "/GameContent/Modules/ToLuaModule/Assets/Lua";
    public static string toluaDir = Application.dataPath + "/GameContent/Modules/ToLuaModule/Assets/ToLua";
