...
namespace GameFramework
{
	...
	public class XMLHelper
	{
	...
	#if UNITY_EDITOR
		#region 自己添加
		public static void ChangedXmlNodeByXpath(string xmlFileName, string xpath, string _value)
		{
			ChangedXmlNodeByXpath (xmlFileName, xpath, _value, null);
		}
		public static void ChangedXmlNodeByXpath(string xmlFileName, string xpath, string _value, Dictionary<string, string> _ns)
		{
			...
			if (_ns != null)
			{
				...
				foreach (KeyValuePair<string, string> _kvp in _ns)
				{
					nsMgr.AddNamespace (_kvp.Key, _kvp.Value);
				}
			}
			XmlNode xmlNode = nsMgr == null ? xmlDoc.SelectSingleNode(xpath) : xmlDoc.SelectSingleNode(xpath, nsMgr);
		...
		{
			return GetXmlNodeByXpath (xmlFileName, xpath, null);
		}
		/// <summary>
		/// 自己重载的
		/// </summary>
		public static XmlNode GetXmlNodeByXpath(string xmlFileName, string xpath, Dictionary<string, string> _ns)
		{
			XmlDocument xmlDoc =new XmlDocument();
			try
			{
